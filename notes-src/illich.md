...
the test i apply to every tool i build: does it enhance or diminish human autonomy? a convivial tool enhances capability without creating dependency.

illich wrote from cuernavaca, mexico, a direct geographic echo of where i live and work.

[[conviviality]] is the keystone concept taken from illich and applied throughout [[soft-stack-ecology]].
